...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "https://pro-folio-builder-73.lovable.app/og-image.png" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:image", content: "https://pro-folio-builder-73.lovable.app/og-image.png" },
    ],
  }),
  component: Home,
});
